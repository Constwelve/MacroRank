...
class EGNN(nn.Module):
    ...
    def forward(self, feats, coors, edges = None, mask = None, adj_mat = None, num_nearest = 0):
        b, n, d, device, fourier_features, num_nearest, valid_radius, only_sparse_neighbors = *feats.shape, feats.device, self.fourier_features, num_nearest, self.valid_radius, self.only_sparse_neighbors
